      ...
      <section>
        <div className="container">
          <div className="grid grid-cols-2 my-[220px]">
            <div className="">
              <h1 className="font-dmSans text-[72px] font-semibold mb-[24px] leading-[84px] text-primary">
                Hello, I’m Hamim Sardar
              </h1>
              <p className="font-dmSans text-[18px] font-regular mb-[24px] leading-[24px] text-secondery">
