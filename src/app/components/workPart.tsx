      ...
      <section className="bg-[#F0F1F3] pt-[248px] pb-[140px]">
        <div className="container">
          <div className="grid grid-cols-2 justify-center items-center">
            <div>
              <h3 className="font-geist text-[48px] font-semibold leading-[56px] text-primary mb-8">Work Process</h3>
              <p className="font-geist text-[16px] font-regular leading-[24px] text-secondery w-[529px]">
                ...
                <span className="block font-geist text-[16px] font-regular leading-[24px] text-secondery mt-4 w-[529px]">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="px-8 py-8 bg-white">
                ...
                <h4 className="group font-geist text-[20px] font-semibold leading-[24px] text-primary mb-3">
                  1. Research
                </h4>
                <p className="font-geist text-[16px] font-regular leading-[24px] text-secondery w-[248px]">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
                  purus arcu.
                </p>
              </div>
              <div className="px-8 py-8 bg-white">
                ...
                <h4 className="font-geist text-[20px] font-semibold leading-[24px] text-primary mb-3">
                  2. Analyze
                </h4>
                <p className="font-geist text-[16px] font-regular leading-[24px] text-secondery w-[248px]">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla
